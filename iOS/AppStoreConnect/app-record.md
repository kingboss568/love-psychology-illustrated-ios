...
Status: verified in App Store Connect on 2026-06-29.

App name: 戀愛心理全圖解

Bundle ID: `com.jiang.visualguide.lovepsychology`

App Store ID: `6785267886`

SKU: `com.jiang.visualguide.lovepsychology`

Primary locale: zh-Hant

Team: Yu Shiung Jiang

Verified source: App Store Connect API returned one app for `com.jiang.visualguide.lovepsychology`.
...
- ID: `6785268820`
- Product ID: `com.jiang.visualguide.lovepsychology.pro.lifetime`
- Type: non-consumable
- Price: TWD 199 base territory `TWN`
- Localized name: `Pro 完整圖解解鎖`
